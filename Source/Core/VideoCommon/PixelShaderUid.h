...
struct pixel_shader_uid_data
{
  ...
  struct
  {
    ...
    u32 ignore_cc : 1; // color combiner output is unused and should be ignored.
    u32 ignore_ac : 1; // alpha combiner output is unused and should be ignored.
    u32 pad1 : 4;
