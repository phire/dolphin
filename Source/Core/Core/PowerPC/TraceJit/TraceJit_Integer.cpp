...
void TraceJit::GenerateConstantOverflow(bool overflow)
{
	if (overflow)
	{
		//XER[OV/SO] = 1
...
void TraceJit::GenerateOverflow()
{
...
void TraceJit::FinalizeCarryOverflow(bool oe, bool inv)
{
	// USES_XER
	if (oe)
	{
...
void TraceJit::GetCarryEAXAndClear()
{
...
void TraceJit::FinalizeCarryGenerateOverflowEAX(bool oe, bool inv)
{
	// USES_XER
	if (oe)
	{
...
void TraceJit::ComputeRC(const Gen::OpArg & arg)
{
	if( arg.IsImm() )
	{
...
void TraceJit::regimmop(int d, int a, bool binary, u32 value, Operation doop, void (XEmitter::*op)(int, const Gen::OpArg&, const Gen::OpArg&), bool Rc, bool carry)
{
	gpr.Lock(d, a);
...
void TraceJit::reg_imm(UGeckoInstruction inst)
{
	INSTRUCTION_START
...
void TraceJit::cmpXX(UGeckoInstruction inst)
{
	// USES_CR
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::boolX(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::extsbx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::extshx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, s = inst.RS;
...
void TraceJit::subfic(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::subfcx(UGeckoInstruction inst)
{
	INSTRUCTION_START;
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::subfex(UGeckoInstruction inst)
{
	INSTRUCTION_START;
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, b = inst.RB, d = inst.RD;
...
void TraceJit::subfmex(UGeckoInstruction inst)
{
	// USES_XER
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::subfzex(UGeckoInstruction inst)
{
	// USES_XER
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::subfx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, b = inst.RB, d = inst.RD;
...
void TraceJit::mulli(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, d = inst.RD;
...
void TraceJit::mullwx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, b = inst.RB, d = inst.RD;
...
void TraceJit::mulhwux(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, b = inst.RB, d = inst.RD;
...
void TraceJit::divwux(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, b = inst.RB, d = inst.RD;
...
void TraceJit::divwx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, b = inst.RB, d = inst.RD;
...
void TraceJit::addx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, b = inst.RB, d = inst.RD;
...
void TraceJit::addex(UGeckoInstruction inst)
{
	// USES_XER
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::addcx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA, b = inst.RB, d = inst.RD;
...
void TraceJit::addmex(UGeckoInstruction inst)
{
	// USES_XER
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::addzex(UGeckoInstruction inst)
{
	// USES_XER
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::rlwinmx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA;
...
void TraceJit::rlwimix(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA;
...
void TraceJit::rlwnmx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::negx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA;
...
void TraceJit::srwx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA;
...
void TraceJit::slwx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA;
...
void TraceJit::srawx(UGeckoInstruction inst)
{
	// USES_XER
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
...
void TraceJit::srawix(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA;
...
void TraceJit::cntlzwx(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITIntegerOff)
	int a = inst.RA;
