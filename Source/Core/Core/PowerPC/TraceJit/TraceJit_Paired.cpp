...
void TraceJit::ps_mr(UGeckoInstruction inst)
{
	INSTRUCTION_START
...
void TraceJit::ps_sel(UGeckoInstruction inst)
{
...
void TraceJit::ps_sign(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITPairedOff)
	if (inst.Rc) {
...
void TraceJit::ps_recip(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITPairedOff)
	if (inst.Rc) {
...
void TraceJit::tri_op(int d, int a, int b, bool reversible, void (XEmitter::*op)(X64Reg, OpArg))
{
	fpr.Lock(d, a, b);
...
void TraceJit::ps_arith(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITPairedOff)
	if (inst.Rc) {
...
void TraceJit::ps_sum(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITPairedOff)
...
void TraceJit::ps_muls(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITPairedOff)
	if (inst.Rc) {
...
void TraceJit::ps_mergeXX(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITPairedOff)
	if (inst.Rc) {
...
void TraceJit::ps_maddXX(UGeckoInstruction inst)
{
	INSTRUCTION_START
	JITDISABLE(bJITPairedOff)
	if (inst.Rc) {
