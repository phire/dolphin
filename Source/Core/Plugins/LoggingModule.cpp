...
static Eumerator LogLevelsEumerators[] {
    {
        .Name = "Notice",
        .Value = Common::Log::LOG_LEVELS::LNOTICE
    },
    {
        .Name = "Error",
        .Value = Common::Log::LOG_LEVELS::LERROR
    },
    {
        .Name = "Warning",
        .Value = Common::Log::LOG_LEVELS::LWARNING
    },
    {
        .Name = "Info",
        .Value = Common::Log::LOG_LEVELS::LINFO
    },
    {
        .Name = "Debug",
        .Value = Common::Log::LOG_LEVELS::LDEBUG
    },
};
